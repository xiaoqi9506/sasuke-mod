...
import sasuke.patches.relics.BottledPlaceholderField;
import sasuke.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static sasuke.Sasuke.makeRelicOutlinePath;
import static sasuke.Sasuke.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = Sasuke.makeID("BottledPlaceholderRelic");
