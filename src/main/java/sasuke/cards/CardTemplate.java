...
public class CardTemplate extends AbstractDynamicCard {
    ...
    // public static final String ID = PHARMACIST.makeID(${NAME}.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    public static final String ID = Sasuke.makeID("DefaultCommonAttack"); // DELETE THIS ONE.
