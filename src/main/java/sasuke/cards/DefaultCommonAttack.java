...
public class DefaultCommonAttack extends CustomCard {
    ...
    public static final String ID = Sasuke.makeID(DefaultCommonAttack.class.getSimpleName());
    ...
    // The list of all of them can be found in the main PHARMACIST.java file in the
    ...
    // Go check out DefaultAttackWithVariable and PHARMACIST.variable.DefaultCustomVariable
